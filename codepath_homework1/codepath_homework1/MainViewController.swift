...
class MainViewController: UIViewController {
    ...
    let SuperpowersContext = Context(title: "Superpowers", image: UIImage(named: "heat_vision")!, description: "As Superman, my physical abilities are far beyond those of a normal human, and I am virtually indestructible. \n \n I have incredible strength, which allows me to lift enormous objects such as buildings, ships, and even mountains with ease. My speed is also unparalleled, and I can travel faster than a speeding bullet. I can fly at incredible speeds and maneuver through the air with great precision. \n \n In addition to my physical abilities, I have a number of other powers that make me unique. I have the ability to emit intense heat from my eyes, known as heat vision, which can melt through virtually any material.")
